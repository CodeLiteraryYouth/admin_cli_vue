<template>
    <div class="mod-config">
        ...
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
            ...
            <el-table-column prop="storyDesc" header-align="center" align="center" label="描述">
            </el-table-column>
            ...
            <el-table-column prop="content" header-align="center" align="center" label="新闻内容">
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                this.$http({
                    url: this.$http.adornUrl('/news/story/list'),
                    method: 'get',
            ...
            deleteHandle(id) {
                ...
                this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
                    ...
                    this.$http({
                        url: this.$http.adornUrl('/news/story/delete'),
                        method: 'delete',
