<template>
    <div class="mod-config">
        ...
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
            ...
            <el-table-column prop="typeId" header-align="center" align="center" label="类型">
            </el-table-column>
            <el-table-column prop="title" header-align="center" align="center" label="标题">
            </el-table-column>
            <el-table-column prop="businessDesc" header-align="center" align="center" label="描述">
            </el-table-column>
            ...
            <el-table-column prop="tags" header-align="center" align="center" label="合作标签">
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                this.$http({
                    url: this.$http.adornUrl('/business/cooperation/list'),
                    method: 'get',
            ...
            addOrUpdateHandle(id) {
                this.$router.push({
					path: "/businesscooperationAddOrUpdate",
					query: id ? {
						id: id
					} : null
				});
            ...
            deleteHandle(id) {
                ...
                this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
                    ...
                    this.$http({
                        url: this.$http.adornUrl('/business/cooperation/delete'),
                        method: 'delete',
