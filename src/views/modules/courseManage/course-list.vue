<template>
    <div class="mod-config">
        ...
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
            ...
            <el-table-column prop="courseTitle" header-align="center" align="center" label="课程标题">
            </el-table-column>
            <el-table-column prop="courseDesc" header-align="center" align="center" label="课程描述">
            </el-table-column>
            <el-table-column prop="courseTag" header-align="center" align="center" label="课程标签">
            </el-table-column>
            <el-table-column prop="coverUrl" header-align="center" align="center" label="封面地址">
            </el-table-column>
            <el-table-column prop="originalPrice" header-align="center" align="center" label="课程原价">
            </el-table-column>
            <el-table-column prop="vipPrice" header-align="center" align="center" label="会员价格">
            </el-table-column>
            <el-table-column prop="courseUrl" header-align="center" align="center" label="课程链接">
            </el-table-column>
