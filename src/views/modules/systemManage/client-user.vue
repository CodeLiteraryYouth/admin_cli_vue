<template>
    <div class="mod-config">
        ...
        <el-table :data="dataList" border v-loading="dataListLoading" style="width: 100%;">
            ...
            <el-table-column prop="email" header-align="center" align="center" label="邮箱地址">
            </el-table-column>
            <el-table-column prop="password" header-align="center" align="center" label="注册密码">
            </el-table-column>
            <el-table-column prop="nickName" header-align="center" align="center" label="用户姓名">
            </el-table-column>
            <el-table-column prop="avatarUrl" header-align="center" align="center" label="用户头像">
            </el-table-column>
            ...
            <el-table-column prop="isMembers" header-align="center" align="center" label="会员">
            ...
            <el-table-column prop="membersType" header-align="center" align="center" label="会员类型">
                <template slot-scope="scope">
            ...
            <el-table-column prop="event" header-align="center" align="center" label="订阅状态">
                <template slot-scope="scope">
