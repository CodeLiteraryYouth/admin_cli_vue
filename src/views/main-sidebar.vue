        ...
        <div class="site-sidebar__inner">
            <el-menu :default-active="menuActiveName || 'home'" :collapse="sidebarFold" :collapseTransition="false" class="site-sidebar__menu">
                ...
                <el-submenu index="listOfWorks">
                    ...
                    <el-menu-item index="listOfWorks" @click="$router.push({ name: 'listOfWorks' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">作品列表</span>
                    </el-menu-item>
                    <el-menu-item index="workLabel" @click="$router.push({ name: 'workLabel' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                ...
                <el-submenu index="demo">
                    ...
                    <el-menu-item index="menuManage" @click="$router.push({ name: 'menuManage' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">菜单管理</span>
                    </el-menu-item>
                    <el-menu-item index="roleManage" @click="$router.push({ name: 'roleManage' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">角色管理</span>
                    </el-menu-item>
                    <el-menu-item index="clientUser" @click="$router.push({ name: 'clientUser' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">客户端用户</span>
                    </el-menu-item>
                    <el-menu-item index="dictionaryParams" @click="$router.push({ name: 'dictionaryParams' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                ...
                <el-submenu index="materialManage">
                    ...
                    <el-menu-item index="materialList" @click="$router.push({ name: 'materialList' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">素材列表</span>
                    </el-menu-item>
                    <el-menu-item index="materialLabel" @click="$router.push({ name: 'materialLabel' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                ...
                <el-submenu index="courseManage">
                    ...
                    <el-menu-item index="courseList" @click="$router.push({ name: 'courseList' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">课程列表</span>
                    </el-menu-item>
                    <el-menu-item index="courseLabel" @click="$router.push({ name: 'courseLabel' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                ...
                <el-submenu index="weeklyPractice">
                    ...
                    <el-menu-item index="weeklyPracticeList" @click="$router.push({ name: 'weeklyPracticeList' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">周练列表</span>
                    </el-menu-item>
                    <el-menu-item index="jobList" @click="$router.push({ name: 'jobList' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                ...
                <el-submenu index="toolManage">
                    ...
                    <el-menu-item index="toolList" @click="$router.push({ name: 'toolList' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">工具列表</span>
                    </el-menu-item>
                    <el-menu-item index="toolLabel" @click="$router.push({ name: 'toolLabel' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">工具标签</span>
                    </el-menu-item>
                    <el-menu-item index="downloadList" @click="$router.push({ name: 'downloadList' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">下载列表</span>
                    </el-menu-item>
                    <el-menu-item index="downloadLabel" @click="$router.push({ name: 'downloadLabel' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
                        <span slot="title">下载标签</span>
                    </el-menu-item>
                    <el-menu-item index="newsStory" @click="$router.push({ name: 'newsStory' })">
                        <icon-svg name="tubiao" class="site-sidebar__menu-icon"></icon-svg>
